      ...
      <div className="modal modal-narrow" role="dialog" aria-modal="true" aria-label="공유 링크">
        ...
        {!made && (
          <>
            ...
            {/* 만들기 전에 미리 말한다. 링크를 보낸 뒤에 알게 되면 이미 늦은 두 가지다.
                항목에 이미지·첨부가 없어도 그대로 둔다 — '이 링크가 무엇을 보장하고
                무엇을 보장하지 않는지' 는 이 기능의 성질이지 이번 항목의 사정이 아니다. */}
            <ul className="share-caveats">
              <li>※ 이미지가 포함된 항목은 이미지 주소에 만료가 적용되지 않습니다</li>
              <li>※ 링크 생성 후 추가한 첨부는 새 링크를 만들어야 표시됩니다</li>
            </ul>
          </>
        )}
