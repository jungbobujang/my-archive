...
// v12 — 계획 격자(지평 × 영역). 탭이 셋이 되고 items 에 계획 열 다섯이 붙었다.
//       🔴 옛 번들에는 계획 탭이 아예 없다. SQL 을 실행해 열을 만들어 둬도 화면에
//          아무것도 나타나지 않아서, 사람은 SQL 이 안 먹은 줄로 안다 — v11 과 같은 종류의
//          어긋남이다(서버는 준비됐는데 화면이 모른다). 그래서 번호를 올려 갈아 끼운다.
